...
//对地图生命周期的管理；
public class MainActivity extends AppCompatActivity implements LocationSource, AMapLocationListener, AMapNaviViewListener, AMapNaviListener {
...
// 设置定位的类型为定位模式，有定位、跟随或地图根据面向方向旋转几种
  ...
  //=======定位========
    public void getDingwei() {
        //声明定位回调监听器
        mMLocationListener = new AMapLocationListener() {
            @Override
...
//设置定位回调监听
        mLocationClient.setLocationListener(mMLocationListener);
